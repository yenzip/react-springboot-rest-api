...
export function Summary({items = [], onOrderSubmit, onCheckEmail}) {
            ...
            <form>
                <div className="mb-3">
                    ...
                    <input type="email" className="form-control mb-1" value={order.email}
                           ...
                           id="email"/>
                    <button type="button" className="btn btn-primary col-12" onClick={handleCheckEmail}>회원 확인</button>
                </div>
                <div className="mb-3">
